    ...
    function($scope, $routeParams,friendsFactory, $location){ //if injected above dont forget to add in as an argument
      ...
      */
      self.update = function() {
        if (!self.currentFriend.firstName || !self.currentFriend.lastName){
          console.log('Not going to factory because missing first name and/or last name or is empty string');
          return;
        }
